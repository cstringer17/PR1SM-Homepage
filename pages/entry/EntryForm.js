...
export default function EntryForm(props) {
  ...
  function sendEmail(templateParams) {
    emailjs
      .send('service_pr1sm', 'templae_pr1sm', templateParams, 'user_KTzGasV9AqAz6WT2jCuzJ')
      .then(
        result => {
    ...
    <div className="py-1 mt-10 bg-gradient-to-r from-red-400 via-pink-400 to-blue-500 rounded max-w-xl mx-auto">
      <div className="pt-1 bg-gray-700">
        <form className="shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={sendRequest}>
          <p className="pb-4">
            If you want to join PR1SM fill out this form. A request will be sent to our team and you
            will hear back from us about your acceptance{' '}
          </p>
          ...
          <HCaptcha sitekey="90500a66-8782-4a96-a51f-b095ed673ff0" onVerify={onVerifyCaptcha} />
